const en = {
  ...
  "dashboard.view.feed": "Feed",
  "dashboard.feed.empty.title": "Nothing here yet",
  "dashboard.feed.empty.description": "Follow other players from their profile to see what they're up to.",
  "activity.followedPlayer": "started following {followee}",
  "activity.joinedTeam": "joined {team}",
  "activity.matchResult.win": "beat {opponent} on {court}",
  "activity.matchResult.loss": "lost to {opponent} on {court}",
  "activity.matchResult.draw": "drew with {opponent} on {court}",
  "activity.challengeCompleted": "completed the challenge \"{challenge}\"",
  "activity.achievementUnlocked": "unlocked {achievement}",
  "activity.openedGame": "opened a game on {court}, looking for players",
  ...
  "book.slot.unavailable": "Unavailable",
  ...
  "profile.tabs.challenges": "Challenges",
  "challenges.empty.title": "No challenges right now",
  "challenges.empty.description": "Check back later for a seasonal push from the venue.",
  ...
  "profile.tabs.rating": "Rating",
  "ratingLeaderboard.empty": "No rated matches yet for this sport — report a result to get started.",
  "ratingLeaderboard.rating": "Rating {rating}",
  ...
  "playerProfile.visibility.title": "Public profile",
  "playerProfile.visibility.publicToggle": "Show my profile to other players",
  "playerProfile.visibility.publicToggleHint": "When off, other players see your name and photo but not your bio, stats or achievements.",
  "playerProfile.visibility.bioLabel": "Bio",
  "playerProfile.visibility.bioPlaceholder": "Tell other players a bit about yourself…",
  "playerProfile.visibility.viewPublic": "View your public profile",
  "playerProfile.back": "Back",
  "playerProfile.follow": "Follow",
  "playerProfile.unfollow": "Unfollow",
  "playerProfile.editOwn": "Edit your profile",
  "playerProfile.private": "This player's profile is private.",
  "playerProfile.followers.label": "followers",
  "playerProfile.followers.title": "Followers",
  "playerProfile.following.label": "following",
  "playerProfile.following.title": "Following",
  "playerProfile.followList.empty": "Nobody here yet.",
  "playerProfile.followList.private": "This list is private.",
  ...
  "playerProfile.recentGames.result.loss": "Loss",
  "playerProfile.recentGames.result.draw": "Draw",
  "playerProfile.error.loadFailed": "Could not load this player's profile",
  "playerProfile.error.followFailed": "Could not update follow status",
  "playerProfile.message": "Message",
  "playerProfile.error.messageFailed": "Could not open the chat",

  "playerSearch.placeholder": "Search players by name",
  "playerSearch.searching": "Searching…",
  "playerSearch.empty": "No players found.",

  "playersDirectory.title": "Players",
  "playersDirectory.nav": "Players",
  "playersDirectory.hint": "Browse public player profiles, or search by name.",
  "playersDirectory.empty": "No public player profiles yet.",
  "playersDirectory.noResults": "No players found.",
  "chat.title": "Chat",
  "chat.empty.title": "No conversations yet",
  "chat.empty.description": "Start a new message, or chat with your guests from a reservation.",
  "chat.selectPrompt": "Select a conversation to start reading",
  ...
  "chat.attachImage": "Attach a photo",
  "chat.error.sendImageFailed": "Could not send the photo",
  ...
  "teams.field.sport.any": "Any sport",
  "teams.field.description": "Description",
  "teams.field.addMemberPlaceholder": "Search players by name or email",
  "teams.empty.title": "No teams yet",
  "teams.empty.description": "Create a team for your regular group, with its own chat and roster.",
  "teams.memberCount": "{count} members",
  "teams.role.owner": "Owner",
  "teams.role.captain": "Captain",
  ...
  "teams.createdAt": "Created {date}",
  "teams.roster.title": "Roster ({count})",
  "teams.roster.remove": "Remove",
  "teams.roster.joinedAt": "Joined {date}",
  "teams.addMember": "Add",
  "teams.leave": "Leave team",
  "teams.avatar.change": "Change team photo",
  "teams.field.isPublic": "Public team",
  "teams.field.isPublic.hint": "Public teams can be found and requested to join from Discover.",
  "teams.tabs.mine": "My teams",
  "teams.tabs.discover": "Discover",
  ...
  "teams.joinRequests.toast.accepted": "Player added to the team",
  "teams.joinRequests.toast.declined": "Request declined",
  "teams.joinRequests.error.decideFailed": "Could not update this request",
  "teams.toast.created": "Team created",
  "teams.toast.updated": "Team updated",
  "teams.toast.avatarUpdated": "Team photo updated",
  "teams.toast.memberAdded": "Member added",
  "teams.toast.roleUpdated": "Role updated",
  "teams.toast.deleted": "Team deleted",
  "teams.error.createFailed": "Could not create the team",
  "teams.error.updateFailed": "Could not update the team",
  "teams.error.avatarFailed": "Could not update the team photo",
  "teams.error.addMemberFailed": "Could not add that player",
  "teams.error.removeMemberFailed": "Could not update the roster",
  "teams.error.roleUpdateFailed": "Could not update that member's role",
  "teams.error.deleteFailed": "Could not delete the team",
  "teams.error.chatFailed": "Could not open the team chat",
  "teams.error.loadFailed": "Could not load this team",
  "confirmDialog.leaveTeam.title": "Leave this team?",
  "confirmDialog.leaveTeam.description": "You'll lose access to the team chat and roster.",
  "confirmDialog.removeTeamMember.title": "Remove this player from the team?",
  "confirmDialog.removeTeamMember.description": "They'll lose access to the team chat immediately.",
  "confirmDialog.deleteTeam.title": "Delete {name}?",
  "confirmDialog.deleteTeam.description": "This removes the team, its roster and its chat history for everyone. This can't be undone.",
  "confirmDialog.deleteMessage.title": "Delete this message?",
  "confirmDialog.deleteMessage.description": "This can't be undone. Other participants will see it as deleted.",
  ...
  "notificationPrefs.reminders.description": "A heads-up before an upcoming reservation.",
  "notificationPrefs.approvals.title": "Approval requests",
  "notificationPrefs.approvals.description": "A booking on your court waiting for your approval.",
  "notificationPrefs.facility.title": "Facility closures",
  "notificationPrefs.facility.description": "A court becomes unavailable during a time you had booked.",
  "notificationPrefs.waitlist.title": "Waitlist",
  "notificationPrefs.waitlist.description": "Joining a waitlist, or a slot opening up for you.",
  "notificationPrefs.achievements.title": "Achievements & challenges",
  "notificationPrefs.achievements.description": "Unlocking a new achievement or completing a seasonal challenge.",
  "notificationPrefs.joinRequests.title": "Open-game join requests",
  "notificationPrefs.joinRequests.description": "Someone asking to join your open game, or a decision on your request to join one.",
  "notificationPrefs.social.title": "New followers",
  "notificationPrefs.social.description": "Someone starts following your player profile.",
  "notificationPrefs.teams.title": "Teams",
  ...
  "courtDetail.gallery.viewPhoto": "View this photo",
  ...
  "occupancy.held": "Held",
  "occupancy.blocked": "Unavailable: {reason}",
  "occupancy.blockedLegend": "Unavailable",
  "occupancy.free": "Free",
  ...
  "reservationCard.recurring": "Recurring",
  ...
  "reservationCard.guest.description": "They need a Courtly account already — search for them to invite to {court}.",
  "reservationCard.guest.email": "Player",
  ...
  "reservationCard.result.button": "Report result",
  "reservationCard.result.title": "Report a match result",
  "reservationCard.result.notEligible": "Only a 1-on-1 booking (you plus exactly one guest) can have a rated result.",
  "reservationCard.result.iWon": "I won",
  "reservationCard.result.theyWon": "{name} won",
  "reservationCard.result.draw": "It was a draw",
  "reservationCard.result.submit": "Report result",
  "reservationCard.result.toast.reported": "Result reported",
  "reservationCard.result.error": "Could not report the result",
  ...
  "profile.error.reviewPhotoFailed": "Could not update the review's photos",
  "profile.reviews.addPhoto": "Add a photo to this review",
  "profile.reviews.removePhoto": "Remove this photo",
  ...
  "reservationDetail.error.chat": "Could not open the chat",
  ...
  "admin.tabs.challenges": "Challenges",
  "admin.challenges.create": "New challenge",
  "admin.challenges.create.title": "Create a seasonal challenge",
  "admin.challenges.create.submit": "Create challenge",
  "admin.challenges.field.title": "Title",
  "admin.challenges.field.description": "Description",
  "admin.challenges.field.sport": "Sport",
  "admin.challenges.field.metric": "Metric",
  "admin.challenges.field.target": "Target",
  "admin.challenges.field.startsAt": "Starts",
  "admin.challenges.field.endsAt": "Ends",
  "admin.challenges.metric.RESERVATIONS_COMPLETED": "Reservations completed",
  "admin.challenges.metric.COURTS_PLAYED": "Distinct courts played",
  ...
  "admin.court.gallery": "Photo gallery",
  "admin.court.gallery.add": "Add a gallery photo",
  "admin.court.gallery.remove": "Remove this photo",
  "admin.court.gallery.hint": "Extra photos shown on the court's detail page, up to 8.",
  "admin.error.galleryRemove": "Could not remove photo",
